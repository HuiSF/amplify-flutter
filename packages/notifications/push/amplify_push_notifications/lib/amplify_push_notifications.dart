...
class AmplifyPushNotifications extends PushNotificationsPluginInterface {
  ...
  AmplifyPushNotifications({
    ...
    _onTokenReceived = _tokenReceivedEventChannel
      ...
      _registerDevice(deviceToken: deviceToken);
      return deviceToken;
    });
    ...
    _onForegroundNotificationReceived = _foregroundNotificationEventChannel
        ...
        .cast<Map<Object?, Object?>>()
        .map((event) {
      print('🚀 Dart FOREGROUND_MESSAGE_RECEIVED: $event');
  ...
  Future<void> _registerDevice({required String deviceToken}) async {
    try {
      _serviceProviderClient.registerDevice(deviceToken);

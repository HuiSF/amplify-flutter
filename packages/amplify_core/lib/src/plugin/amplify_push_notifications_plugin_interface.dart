...
abstract class PushNotificationsPluginInterface extends AmplifyPluginInterface {
  ...
  Stream<String> get onTokenReceived {
    throw UnimplementedError('onTokenReceived getter has not been implemented');
  }
  ...
  Stream<PushNotificationMessage> get onNotificationReceivedInForeground {
    throw UnimplementedError(
        'onForegroundNotificationReceived getter has not been implemented');
  }

  /// {@macro amplify_core.amplify_notifications_category.on_foreground_notification_received}
  Stream<PushNotificationMessage> get onNotificationReceivedInBackground {
    throw UnimplementedError(
        'onNotificationReceivedInBackground getter has not been implemented');
  }
  ...
  Stream<PushNotificationMessage> get onNotificationOpened {
    throw UnimplementedError(
        'onNotificationOpened getter has not been implemented');
  }

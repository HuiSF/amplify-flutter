...
void main() {
  group('StorageS3Item.fromS3Object()', () {
    const testETag = '1234';
    ...
    test('should create a StorageS3Item from Smithy S3Object object', () {
      ...
      final storageS3Item = StorageS3Item.fromS3Object(
        testS3Object,
    ...
    test(
      ...
      try {
        StorageS3Item.fromS3Object(
          testS3Object,
          prefixToDrop: testPrefixToDrop,
        );
      } on StorageS3Exception catch (error) {
        expect(error, StorageS3Exception.unknownException());
      }
    });
  });
}

...
/// This defines an object in a S3 bucket.
/// {@endtemplate}
class StorageS3Item extends StorageItem {
  ...
  /// Creates a [StorageS3Item] from [S3Object] provided by smithy.
  /// This named constructor should be used internally only.
  @internal
  factory StorageS3Item.fromS3Object(
    S3Object object, {
    ...
    if (key == null) {
      throw StorageS3Exception.unknownException();
    }

    final keyDroppedPrefix = key.replaceRange(0, prefixToDrop.length, '');

    return StorageS3Item(
...
/// A list of [StorageS3Item].
typedef StorageS3Items = StorageItems<StorageS3Item>;

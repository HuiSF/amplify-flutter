...
class StorageS3Service {
  ...
  StorageS3Service({
    ...
    required StorageS3PrefixResolver prefixResolver,
  ...
  final StorageS3PrefixResolver _prefixResolver;
  ...
  /// [StorageS3ListResult] based on [PaginatedResult] returned by
  /// [S3Client.listObjectsV2] API.
  Future<StorageS3ListResult> list({
    required String path,
    required StorageS3ListOptions options,
  }) async {
    ...
    try {
      ...
      throw StorageS3Exception.fromUnknownSmithyHttpException(error);
    }
  }

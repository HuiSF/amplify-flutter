...
/// {@endtemplate}
class AmplifyStorageS3DartBase extends StoragePluginInterface<
  ...
  static const StoragePluginKey<
      ...
      S3StorageItem,
      S3TransferProgress,
      AmplifyStorageS3DartBase> pluginKey = _AmplifyStorageS3DartPluginKey();
  ...
  @protected
  StorageS3Service get storageS3Service => _dependencyManager.expect();
